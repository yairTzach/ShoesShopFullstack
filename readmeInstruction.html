...
│   ├── Review.js          
│   ├── User.js             
│   └── products.json        <!-- Includes your initial product data -->
│
├── node_modules/           
│   └── [dependencies]      
│
...
│   │   ├── thankYouReview.js
│   │   └── test/
│   │       └── test.js             <!-- Your test file located in the public/js/test directory -->
│
├── routes/                 
│   ├── adminRouter.js      
│   ├── adminTrackRouter.js 
...
│   ├── thankYouRouter.js   
│   └── ThankYouReviewRouter.js    <!-- Added ThankYouReviewRouter.js here -->
│
├── utils/                  
│   └── persist.js          
│
├── userData/
│   └── [user data files]   <!-- Contains user data in JSON format -->
│
├── .env                    
├── server.js                  
├── package.json            
...
# 2. Locate the downloaded zip file and right-click on it to extract its contents. 
#    This will create a folder with all the project files.
# 3. Open your terminal application (on Windows, you can use Command Prompt or PowerShell; 
#    on macOS and Linux, you can use the Terminal app).
